...
const BOOST_OPTIONS = [
  ...
  { days: 3, credits: 30, label: "Vetrina 3g", icon: Store, desc: "3 giorni in evidenza", color: "from-purple-500 to-pink-600" },
  { days: 7, credits: 70, label: "Vetrina 7g", icon: Store, desc: "1 settimana in evidenza", color: "from-pink-500 to-rose-600" },
  { days: 30, credits: 150, label: "Premium 30g", icon: Crown, desc: "5 foto + badge per 30 giorni", color: "from-amber-500 to-orange-600" },
];
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {BOOST_OPTIONS.map((opt) => {
                          ...
                          return (
                            <button
                              key={opt.label}
                              onClick={() => requestBoost(ad, opt.credits, opt.days, type)}
